...
function toSummary(row: {
  slug: string; title: string; flashpointId: string | null; andkonPath: string | null;
  developer: string; description: string; tags: string; fileName: string | null;
  width: number; height: number; isActionScript3: boolean;
}): FlashGameSummary {
